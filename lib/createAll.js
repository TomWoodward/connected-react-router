...
var _ConnectedRoute2 = _interopRequireDefault(_ConnectedRoute);
...
var createAll = function createAll(structure) {
  return _extends({}, _get__('actions'), _get__('createSelectors')(structure), {
    ConnectedRoute: _get__('createConnectedRoute')(structure),
...
function _get_original__(variableName) {
  switch (variableName) {
    ...
    case 'createConnectedRoute':
      return _ConnectedRoute2.default;
