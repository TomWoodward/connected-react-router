 ...
 */
var ROUTE_MATCHED = exports.ROUTE_MATCHED = '@@router/ROUTE_MATCHED';

var onRouteMatched = exports.onRouteMatched = function onRouteMatched(match) {
  return {
    type: _get__('ROUTE_MATCHED'),
    payload: match
  };
};
